...
<section class="content">
	...
	<div style="width: 500px; text-align:center;margin-left:60%;">
		<i>Hà Nội, ngày<input type="date" name="contract_date">
		<!-- tháng<input type="number" name="month" style="width:45px; text-align:center">
		năm<input type="number" name="year" style="width:45px; text-align:center"> --></i>
	</div>
	<h3 style="text-align:center">HỢP ĐỒNG MUA BÁN NHÀ Ở XÃ HỘI<br><br>
	Số <input type="text" name="contract_code" style="width:80px; text-align:center">/2019/HĐMBCHXH/BKTL - TL </h3>
...
<div class="contract_content">
	<strong>CĂN HỘ: </strong><input type="text" name="tencanho"><br><br>
