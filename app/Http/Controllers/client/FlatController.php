...
class FlatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('client.flat.index',['flat_array'=>$flats]);
    }
    ...
    public function create()
    {
        ...
        return view("client.flat.create",['available_project_list'=>$available_project],['available_apartment_list'=>$available_apartment]);
    }
    ...
    public function edit($id)
    {
        ...
        return view("client.flat.edit",compact('flat'),['apartments'=>$apartments]);
    }
