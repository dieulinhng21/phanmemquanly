...
class ApartmentController extends Controller
{
    ...
    public function index()
    {
        ...
        // return view("client.apartment.index", array('model' => $apartment));
        $apartments = DB::table('toachungcu')
                        ->join('duan','toachungcu.idduan','=','duan.idduan')
                        ->select('toachungcu.*','duan.idduan','duan.tenduan')
                        ->paginate(5);
        return view('client.apartment.index',['apartment_array'=>$apartments]);
    }
    ...
    public function create()
    {
        ...
        return view("client.apartment.create",['projects'=>$projects]);
    }
    ...
    public function store(Request $request)
    {
        ...
        [
            ...
            return redirect('/client/apartment');
    }
    ...
    public function edit($id)
    {
        ...
        return view("client.apartment.edit", compact('apartment','projects'));
    }
