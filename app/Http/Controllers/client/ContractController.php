...
class ContractController extends Controller
{
    ...
    { 
        ...
        $contracts = DB::table('hopdong')
                        ...
                        ->paginate(5);
        return view('client.contract.index',['contract_array'=>$contracts]);
    }
    ...
    public function create()
    {
        ...
        return view('client.contract.create',compact('projects','customers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        [
            ...
            if(strtotime($date)!='0000-00-00' && $kind == 1){
                ...
                return view('client.contract.create');
            }else{
    ...
    public function edit($id)
    {
        ...
        return view('client.contract.edit',compact("contract","customer","flat","projects"));
    }
